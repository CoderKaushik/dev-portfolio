...
export function Footer() {
  ...
  return (
    <footer className="border-t border-gray-800 bg-gray-900/50 backdrop-blur-md">
      <div className="container flex flex-col items-center justify-between gap-4 py-10 md:h-24 md:flex-row md:py-0 px-4 md:px-6 lg:px-8 mx-auto">
        ...
        >
          <p className="text-center text-sm leading-loose text-gray-300 md:text-left">
            Built by <span className="text-blue-400">Hiteshwar Kaushik</span>. Powered by{" "}
            <span className="text-purple-400">Next.js</span> and{" "}
            <span className="text-indigo-400">shadcn/ui</span>.
          </p>
        </motion.div>
