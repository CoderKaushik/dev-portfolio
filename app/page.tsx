      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <Link href="/contact">
            <Button
              variant="outline"
              className="px-8 py-4 text-lg border border-gray-700/50 hover:border-gray-700 text-gray-300 font-bold rounded-2xl transition-all transform hover:scale-[1.02] shadow-sm hover:shadow-gray-700/20"
            >
